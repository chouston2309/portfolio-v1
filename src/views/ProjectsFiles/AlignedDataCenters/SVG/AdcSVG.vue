...
#adc-logo.active #o-1, #adc-logo.active #o-2, #adc-logo.active #o-3, #adc-logo.active #o-4, #adc-logo.active #o-5, #adc-logo.active #o-6 {
   stroke-width: 5;
}

#adc-logo #adc-left, #adc-logo #adc-right {
    fill: white;
    transition: .5s;
